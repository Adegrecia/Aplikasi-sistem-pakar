...
<html><head>
    ...
    <base href="http://localhost/kerusakan_hp/">
  ...
  <body id="pakarayam" class="hold-transition skin-pink sidebar-mini" >
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa" aria-hidden="true"></i>AAS</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa" aria-hidden="true"></i>AAS</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari AAS 1.0</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
